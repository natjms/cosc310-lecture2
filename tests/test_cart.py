...
# TO/DO: add one test of your own. What behaviour is not covered above?

# NOTE: All of the tests described in the exercise have already been implemented in the starter code. This is one line I noticed that wasn't covered by existing tests

def test_empty_cart_repr():
	cart = Cart()
	assert str(cart) == '<Cart 0 items, $0.00>'
